...
class OAuthConsumerMixin(object):
    """
    A :ref:`PeeWee declarative mixin <peewee:declarative_mixins>` with
...
class PeeweeBackend(BaseBackend):
    """
    ...
    def __init__(self, model, session,
        ...
        """
        Args:
            model: The peewee model class that represents the OAuth token
                ...
                inherit from
                :class:`~flask_dance.consumer.storage.*.OAuthConsumerMixin`.
            session:
